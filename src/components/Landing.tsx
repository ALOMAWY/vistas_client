      ...
      <div className="widgets-layer">
        <div className="container-75">
          <div className="row justify-content-between">
            ...
            >
              <p
                className="text-white fs-5 fw-bold ls-none "
              ...
              <h3 className="text-white fw-bold">
                <span className="large-text quote position-relative">
                  {t("landing.heading.quality")}
                </span>
                <span className="medium-text">
                  {t("landing.heading.fabrics")}
                </span>
                <span className="large-text">
                  {t("landing.heading.unique")}
                </span>
                <span className="medium-text">
                  {t("landing.heading.creations")}
                </span>
              </h3>
            </div>
